  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      ...
      if (settings.navigation_arrows) {
        container.append($('<a href="#" style="height: 200px; margin-top: -100px;"><span></span></a>').addClass(settings.prev_class));
        container.append($('<a href="#" style="height: 200px; margin-top: -100px;"><span></span></a>').addClass(settings.next_class));
      }
