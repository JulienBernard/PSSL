				...
				<table class="large-12">
					<tbody>
						...
						?>
							<tr>
								...
								<td class="center large-3 columns"><a href="#" data-dropdown="dropFeature1"><?php echo (String)ucwords($usersList[$i]['name']); ?></a></td>
								<td class="center large-2 columns"><a href="#" data-dropdown="dropFeature1"><?php echo (String)ucwords($usersList[$i]['username']); ?></a></td>
								<td class="smaller center large-2 columns"><?php if( (String)$usersList[$i]['token'] == $usersList[$i]['id'] ) echo "Not activated"; else echo (String)$usersList[$i]['token']; ?></td>
					...
					<tfoot>
						...
						<tr>
							...
							<th class="center large-3 columns">Name</th>
							<th class="center large-2 columns">Username</th>
							<th class="smaller center large-2 columns">Private Token</th>
