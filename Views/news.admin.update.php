	<main id="main">
		<div class="row">
			...
			<div class="large-9 small-9 columns">
				...
				<form action="news.php?update=<?php echo $News->getId(); ?>" method="POST">
					<div class="row collapse ">
						<div class="small-4 large-4 columns">
							<span class="prefix radius"><label for="title">Titre de l'actu</label></span>
						</div>
						<div class="small-8 large-8 columns">
							<input type="text" name="title" id="title" placeholder="(Required) Enter your new title ..." value="<?php echo $title; ?>">
						</div>
					</div>
